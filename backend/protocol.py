"""Shared client/server protocol for the realtime assistant.
...
"""Key for assistant reply text on :class:`OrchestrateResult`."""
...
def speaking_turn_payload(
    *,
    ...
    """JSON payload for a speaking turn (state + transcript snippets for the UI)."""
    return {
